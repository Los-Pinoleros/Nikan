...
<div class="admin-body">
    <h1 class="admin-title">Gestión de Poesía</h1>
    <p class="admin-sub">Administra las secciones y las obras del área de poesía.</p>
                ...
                <?php foreach ($obras as $o): ?>
                    <div class="admin-item obra-item" data-seccion="<?php echo $o['seccion_id']; ?>">
                        <div class="item-main">
                            ...
                            <span class="item-sub"><?php echo htmlspecialchars($o['autor']); ?><?php echo $o['tema'] ? ' · ' . htmlspecialchars($o['tema']) : ''; ?></span>
                        </div>
                        <div class="item-actions">
...
<div id="modalSeccion" class="modal" style="display:none;">
    <div class="modal-box">
        ...
        <form id="formSeccion" method="post" action="poe_actions.php">
...
<div id="modalObra" class="modal" style="display:none;">
    <div class="modal-box modal-box--wide">
        ...
        <form id="formObra" method="post" action="poe_actions.php" enctype="multipart/form-data">
            ...
            <div class="modal-row">
                <div>
                    <label class="admin-label">Tema</label>
                    <select name="tema" id="obra_tema" class="admin-input">
                ...
                <div>
                    <label class="admin-label">Año / época</label>
                    <input name="anio" id="obra_anio" class="admin-input">
                </div>
            </div>

            <label class="admin-label">Poema (completo o fragmento)</label>
            <textarea name="poema" id="obra_poema" class="admin-input admin-textarea"></textarea>

            <label class="admin-label">Ficha del autor</label>
            <textarea name="bio" id="obra_bio" class="admin-input"></textarea>

            <label class="admin-label">Detalle / comentario de la obra</label>
            <textarea name="detalle" id="obra_detalle" class="admin-input admin-textarea"></textarea>

            <label class="admin-label">Imagen (retrato / ilustración, opcional)</label>
...
<style>
    ...
    .admin-textarea { min-height: 130px; resize: vertical; }
...
function obraEditar(id) {
    ...
    if (id) {
        ...
        document.getElementById('obra_tema').value = o.tema || '';
        document.getElementById('obra_anio').value = o.anio || '';
        document.getElementById('obra_poema').value = o.poema || '';
        document.getElementById('obra_bio').value = o.bio || '';
