...
<div class="admin-body">
    <h1 class="admin-title">Gestión de Literatura</h1>
    <p class="admin-sub">Administra las secciones y las obras del área de literatura.</p>
                ...
                <?php foreach ($obras as $o): ?>
                    <div class="admin-item obra-item" data-seccion="<?php echo $o['seccion_id']; ?>">
                        <div class="item-main">
                            ...
                            <span class="item-sub"><?php echo htmlspecialchars($o['autor']); ?> · <?php echo htmlspecialchars($o['genero']); ?></span>
                        </div>
                        <div class="item-actions">
...
<div id="modalSeccion" class="modal" style="display:none;">
    <div class="modal-box">
        ...
        <form id="formSeccion" method="post" action="lit_actions.php">
...
<div id="modalObra" class="modal" style="display:none;">
    <div class="modal-box">
        ...
        <form id="formObra" method="post" action="lit_actions.php">
            ...
            <label class="admin-label">Sinopsis breve</label>
            <textarea name="sinopsis" id="obra_sinopsis" class="admin-input"></textarea>
            <label class="admin-label">Fragmento o cita</label>
            <textarea name="fragmento" id="obra_fragmento" class="admin-input"></textarea>
            ...
            <input type="file" name="imagen_file" id="obra_imagen_file" class="admin-input" accept="image/*">
...
<style>
    ...
    .modal-box .admin-textarea { min-height: 110px; resize: vertical; }
...
async function guardarSeccion() {
    ...
    const r = await postForm('lit_actions.php', fd);
...
function obraEditar(id) {
    ...
    if (id) {
        ...
        document.getElementById('obra_sinopsis').value = o.sinopsis || '';
        document.getElementById('obra_fragmento').value = o.fragmento || '';
        document.getElementById('obra_detalle').value = o.detalle || '';
        document.getElementById('obra_imagen').value = o.imagen || '';
        document.getElementById('obra_imagen_file').value = '';
