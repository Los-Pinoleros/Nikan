                ...
                <?php foreach ($obras as $o): ?>
                    <div class="admin-item obra-item" data-seccion="<?php echo $o['seccion_id']; ?>">
                        ...
                        <div class="item-main">
                            ...
                            <span class="item-sub"><?php echo htmlspecialchars($o['autor']); ?> · <?php echo htmlspecialchars($o['anio']); ?></span>
                        </div>
                        <div class="item-actions">
...
<div id="modalSeccion" class="modal" style="display:none;">
    <div class="modal-box">
        ...
        <form id="formSeccion" method="post" action="arte_actions.php">
...
<div id="modalObra" class="modal" style="display:none;">
    <div class="modal-box">
        ...
        <form id="formObra" method="post" action="arte_actions.php" enctype="multipart/form-data">
            ...
            <label class="admin-label">Técnica</label>
            <input name="tecnica" id="obra_tecnica" class="admin-input">
...
async function guardarSeccion() {
    ...
    const r = await postForm('arte_actions.php', fd);
...
function obraEditar(id) {
    ...
    if (id) {
        ...
        document.getElementById('obra_tecnica').value = o.tecnica || '';
